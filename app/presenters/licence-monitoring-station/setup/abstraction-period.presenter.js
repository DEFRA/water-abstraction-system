...
// - User came from select condition page, in which case back link should go to select condition page; this is done.
// - User came directly from check page, in which case back link should go to check page; this is also done.
// - User came from select condition page but prior to that they came from the check page; this is _NOT_ done as
//   currently, checkPageVisited will be true and they will therefore be returned to the check page. We need to fix this
//   but will do this once check page is in place so we can more easily develop and test this logic.
