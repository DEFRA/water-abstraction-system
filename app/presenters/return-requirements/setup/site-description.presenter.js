...
/**
 * Formats data for the `/return-requirements/setup/{sessionId}/site-description` page
...
function _backLink (session, requirementIndex) {
  ...
  return `/system/return-requirements/setup/${id}/returns-cycle/${requirementIndex}`
}
