...
function go (licenceVersionPurpose) {
  return {
    ...
    primaryPurposeId: licenceVersionPurpose.primary_purpose_code,
    secondaryPurposeId: licenceVersionPurpose.secondary_purpose_code,
    purposeId: licenceVersionPurpose.purpose_code,
