...
const HapiPinoPlugin = {
  ...
  options: {
    ...
    // There is no value spawning it in test where logging is suppressed via HapiPinoLogInTestService, and it avoids
    // leaving worker threads alive after each Hapi server is created.
    transport:
