 ...
 * result
 *
 * @param {String} billRunId The Charging Module UUID of the bill run the new invoices will be assigned to
...
*/
async function go (billRunId, invoiceId) {
  const path = `v3/wrls/bill-runs/${billRunId}/invoices/${invoiceId}/rebill`
