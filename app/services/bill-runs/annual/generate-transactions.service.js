...
const CalculateAuthorisedAndBillableDaysServiceService = require('../supplementary/calculate-authorised-and-billable-days.service.js')
...
function go (billLicenceId, chargeReference, billingPeriod, chargePeriod, newLicence, waterUndertaker) {
  ...
  if (!waterUndertaker) {
    ...
    if (standardTransaction.id === compensationTransaction.id) {
      throw new Error('Transaction IDs are the same!')
    }
  }
