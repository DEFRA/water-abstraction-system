 ...
 * @param referenceCode
 */
function go(recipients, returnsPeriod, referenceCode) {
  const notifications = []

  for (const recipient of recipients) {
    if (recipient.email) {
      notifications.push(_email(recipient, returnsPeriod, referenceCode))
    } else {
      notifications.push(_letter(recipient, returnsPeriod, referenceCode))
    }
  }
...
function _email(recipient, returnsPeriod, referenceCode) {
  return {
...
function _letter(recipient, returnsPeriod, referenceCode) {
