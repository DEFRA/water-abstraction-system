...
/**
 * Orchestrates validating the data for `/return-requirements/setup/{sessionId}/note` page
 * @module SubmitNoteService
 */

const NotePresenter = require('../../../presenters/return-requirements/setup/note.presenter.js')
const NoteValidator = require('../../../validators/return-requirements/setup/note.validator.js')
