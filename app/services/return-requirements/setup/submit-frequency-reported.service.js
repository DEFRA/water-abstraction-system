...
/**
 * Orchestrates validating the data for `/return-requirements/setup/{sessionId}/frequency-reported` page
 * @module SubmitFrequencyReportedService
 */

const FrequencyReportedPresenter = require('../../../presenters/return-requirements/setup/frequency-reported.presenter.js')
const FrequencyReportedValidator = require('../../../validators/return-requirements/setup/frequency-reported.validator.js')
