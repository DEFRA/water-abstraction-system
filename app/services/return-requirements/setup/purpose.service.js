...
/**
 * Orchestrates fetching and presenting the data for `/return-requirements/setup/{sessionId}/purpose` page
 * @module PurposeService
 */

const FetchPurposesService = require('./fetch-purposes.service.js')
const SelectPurposePresenter = require('../../../presenters/return-requirements/setup/purpose.presenter.js')
