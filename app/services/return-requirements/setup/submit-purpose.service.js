...
/**
 * Orchestrates validating the data for `/return-requirements/setup/{sessionId}/purpose` page
 * @module SubmitPurposeService
 */

const FetchPurposesService = require('./fetch-purposes.service.js')
const GeneralLib = require('../../../lib/general.lib.js')
const PurposePresenter = require('../../../presenters/return-requirements/setup/purpose.presenter.js')
const PurposeValidation = require('../../../validators/return-requirements/setup/purpose.validator.js')
