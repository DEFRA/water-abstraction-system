...
/**
 * Orchestrates fetching and presenting the data for `/return-requirements/setup/{sessionId}/cancel` page
 * @module CancelService
 */

const CancelPresenter = require('../../../presenters/return-requirements/setup/cancel.presenter.js')
