 ...
 * `/return-requirements/setup/{sessionId}/remove/{requirementIndex}` page
 * @module RemoveService
 */

const RemovePresenter = require('../../../presenters/return-requirements/setup/remove.presenter.js')
