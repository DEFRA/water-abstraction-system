...
/**
 * Orchestrates validating the data for `/return-requirements/setup/{sessionId}/points` page
...
const PointsValidator = require('../../../validators/return-requirements/setup/points.validator.js')
