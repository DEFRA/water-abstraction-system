...
/**
 * Orchestrates validating the data for `/return-requirements/setup/{sessionId}/frequency-collected` page
 * @module SubmitFrequencyCollectedService
 */

const FrequencyCollectedPresenter = require('../../../presenters/return-requirements/setup/frequency-collected.presenter.js')
const FrequencyCollectedValidator = require('../../../validators/return-requirements/setup/frequency-collected.validator.js')
