 ...
 * would be missed for that financial year and will need to be included in the supplementary billing run.
 *
 ...
 *
 * The uses the workflows createdAt date and the licences regionId to check if any annual bill runs occurred while the
 * licence was in workflow.
 ...
 *
 * Searches for any annual bills runs that have been created since the workflow records `createdAt` date. Uses the
