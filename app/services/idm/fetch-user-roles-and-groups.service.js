 ...
 *
 * @returns {Promise<object>} result - A promise that resolves to an object containing:
 * - {UserModel|null} user: The `UserModel` representing the user, or `null` if the user is not found.
 * - {RoleModel[]} roles: An array of `RoleModel` objects representing the roles the user has.
 * - {GroupModel[]} groups: An array of `GroupModel` objects representing the groups the user is a member of.
 */
