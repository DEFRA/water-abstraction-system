 ...
 * Fetches a session by its unique identifier.
 *
 * When the session does not exist, it throws a SessionNotFoundError. This is caught
 * upstream and used to show the user a specific error message related to the session
 * being invalid, rather than the generic 'There's a problem with the service'.
 *
