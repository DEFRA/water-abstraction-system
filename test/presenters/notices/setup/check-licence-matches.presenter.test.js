...
// Thing under test
const CheckLicenceMatchesPresenter = require('../../../../app/presenters/notices/setup/check-licence-matches.presenter.js')

describe('Notices - Setup - Check Licence Matches presenter', () => {
