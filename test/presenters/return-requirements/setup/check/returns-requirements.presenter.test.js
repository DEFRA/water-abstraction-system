...
// Thing under test
const ReturnRequirementsPresenter = require('../../../../../app/presenters/return-requirements/setup/check/returns-requirements.presenter.js')

describe('Return Requirements Setup - Return Requirements presenter', () => {
  let journey
  let point
  let requirement
