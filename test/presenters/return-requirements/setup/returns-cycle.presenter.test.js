...
// Thing under test
const ReturnsCyclePresenter = require('../../../../app/presenters/return-requirements/setup/returns-cycle.presenter.js')

describe('Return Requirements Setup - Returns Cycle presenter', () => {
  ...
  describe('when provided with a session', () => {
    it('correctly presents the data', () => {
      ...
      expect(result).to.equal({
        backLink: '/system/return-requirements/setup/61e07498-f309-4829-96a9-72084a54996d/abstraction-period/0',
  ...
  describe('the "backLink" property', () => {
    ...
    describe('when the user has come from somewhere else', () => {
      it('returns a link back to the "abstraction-period" page', () => {
        ...
        expect(result.backLink).to.equal('/system/return-requirements/setup/61e07498-f309-4829-96a9-72084a54996d/abstraction-period/0')
      })
    })
  })
