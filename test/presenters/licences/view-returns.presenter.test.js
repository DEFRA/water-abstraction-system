...
// Thing under test
const ViewReturnsPresenter = require('../../../app/presenters/licences/view-returns.presenter.js')

describe('Licences - View Returns presenter', () => {
  let returnLogs
  let hasRequirements
  let licence
  ...
  describe('when provided with returns data', () => {
    it('correctly presents the data', () => {
      const result = ViewReturnsPresenter.go(returnLogs, hasRequirements, licence)
