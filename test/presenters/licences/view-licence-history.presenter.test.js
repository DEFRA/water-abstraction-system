      ...
      expect(result).to.equal({
        ...
        entries: [
          ...
          },
          {
            ...
            displayNote: true,
            notes: ['Test note'],
            link: '/system/return-requirements/3f09ce0b-288c-4c0b-b519-7329fe70a6cc',
            reason: 'New licence',
    ...
    describe('the "link" property', () => {
      ...
      describe('when the entry is a "return-version"', () => {
        it('returns the return version link', () => {
          ...
          expect(result.entries[2].link).to.equal('/system/return-requirements/3f09ce0b-288c-4c0b-b519-7329fe70a6cc')
        })
      })
    })
