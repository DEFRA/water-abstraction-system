...
// Thing under test
const ViewSummaryPresenter = require('../../../app/presenters/licences/view-summary.presenter.js')

describe('Licences - View Summary Presenter', () => {
  let licence
  ...
  describe('when provided with a populated licence', () => {
    it('correctly presents the data', () => {
      const result = ViewSummaryPresenter.go(licence)
