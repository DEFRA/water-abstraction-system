...
// Thing under test
const ViewSummaryContentPresenter = require('../../../app/presenters/licences/view-summary-content.presenter.js')

describe('Licences - View Summary Content Presenter', () => {
  let licence
  ...
  it('correctly presents the data', () => {
    const result = ViewSummaryContentPresenter.go(licence)
