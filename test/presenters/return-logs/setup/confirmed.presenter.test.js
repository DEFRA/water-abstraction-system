...
// Thing under test
import ConfirmedPresenter from '../../../../src/presenters/return-logs/setup/confirmed.presenter.js'
  ...
  describe('when provided with a return log', () => {
    it('correctly presents the data', () => {
      ...
      expect(result).toEqual({
        ...
        viewThisReturnLink: '/system/return-logs/1f4287ca-b8c5-4034-957f-5d642cdf19d5/details'
      })
    })
  })
