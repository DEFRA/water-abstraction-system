...
function alertNoticeAdditionalContact() {
  ...
  return {
    ...
    email,
    licence_refs: [LicenceHelper.generateLicenceRef()],
    message_type: 'Email'
  }
}
...
function renewalInvitationLicenceHolder() {
  ...
  const recipient = {
    ...
    contact_type: 'licence holder',
    email: null,
    licence_ref: LicenceHelper.generateLicenceRef(),
    message_type: 'Letter'
  }
...
function returnsNoticeLicenceHolder(download = false) {
  ...
  const recipient = {
    ...
    message_type: 'Letter',
    notificationDueDate: futureDueDate('letter'),
    return_reference: ReturnRequirementHelper.generateReference(),
...
function _addLicenceHolderWithMultipleLicences() {
  return {
    ...
    contact_type: 'licence holder',
    email: null,
    licence_refs: [LicenceHelper.generateLicenceRef(), LicenceHelper.generateLicenceRef()],
    message_type: 'Letter',
    return_log_ids: [generateUUID()]
  }
}
