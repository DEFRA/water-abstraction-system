...
function defaults (data = {}) {
  ...
  const defaults = {
    externalId,
    purposeId: _getRandomOption(Purposes.data),
    primaryPurposeId: _getRandomOption(PrimaryPurposes.data),
    secondaryPurposeId: _getRandomOption(SecondaryPurposes.data),
