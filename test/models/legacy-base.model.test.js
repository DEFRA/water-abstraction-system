...
describe('Legacy Base model', () => {
  ...
  describe('when the legacy table a model is based on has non-standard columns', () => {
    class YeOldeBillingModel extends LegacyBaseModel {
      static get translations () {
        return [{ database: 'yehAlrightLove', model: 'greeting' }]
      }
    }
    ...
    it('translates the standard model properties back when talking to the database', () => {
      const yeOldeBilling = new YeOldeBillingModel()
