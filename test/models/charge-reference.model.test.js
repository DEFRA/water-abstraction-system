  ...
  describe('Relationships', () => {
    describe('when linking to bill run volumes', () => {
      ...
      beforeEach(async () => {
        ...
        testBillRunVolumes = []
        for (let i = 0; i < 2; i++) {
          const billRunVolume = await BillRunVolumeHelper.add({ chargeReferenceId: testRecord.id })
    ...
    describe('when linking to charge elements', () => {
      ...
      beforeEach(async () => {
        ...
        testChargeElements = []
        for (let i = 0; i < 2; i++) {
          const chargeElement = await ChargeElementHelper.add({ description: `CP ${i}`, chargeReferenceId: testRecord.id })
