...
// Thing under test
const FrequencyReportedValidator = require('../../../../app/validators/return-requirements/setup/frequency-reported.validator.js')

describe('Return Requirements Setup - Frequency reported validator', () => {
  let payload
