...
// Thing under test
const FrequencyCollectedValidator = require('../../../../app/validators/return-requirements/setup/frequency-collected.validator.js')

describe('Return Requirements Setup - Frequency Collected validator', () => {
  let payload
