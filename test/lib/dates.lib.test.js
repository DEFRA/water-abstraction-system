...
describe('Dates lib', () => {
  ...
  describe('isDateBetweenRange', () => {
    describe('when a date is between the date provided date range', () => {
      it('should return true', () => {
        const result = DateLib.isDateBetweenRange(
          new Date('2022-04-01'),
          new Date('2022-01-01'),
          new Date('2022-12-31')
        )
    ...
    describe('when a range spans multiple years', () => {
      it('should return true', () => {
        const result = DateLib.isDateBetweenRange(
          new Date('2021-04-01'),
          new Date('2021-01-01'),
    ...
    describe('when a date is on the lower limit of the range)', () => {
      it('should return true', () => {
        const result = DateLib.isDateBetweenRange(
          new Date('2022-01-01'),
          new Date('2022-01-01'),
    ...
    describe('when a date is on the upper limit of the range)', () => {
      it('should return true', () => {
        const result = DateLib.isDateBetweenRange(
          new Date('2022-12-31'),
          new Date('2022-01-01'),
    ...
    describe('when a date is not between the date provided date range', () => {
      it('should return true', () => {
        const result = DateLib.isDateBetweenRange(
          new Date('2023-04-01'),
          new Date('2022-01-01'),
