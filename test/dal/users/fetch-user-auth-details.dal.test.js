...
// Thing under test
import FetchUserAuthDetailsService from '../../../src/dal/users/fetch-user-auth-details.dal.js'
...
describe('Users - Fetch User Auth Details DAL', () => {
  ...
  describe('when the user exists', () => {
    it('returns the user', async () => {
      const result = await FetchUserAuthDetailsService(user.userId)
  ...
  describe('when the user does not exist', () => {
    ...
    it('returns "null" for "user"', async () => {
      const result = await FetchUserAuthDetailsService(unknownUserId)
