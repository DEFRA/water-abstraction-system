...
describe('Users - View User service', () => {
  ...
  describe('when the user is an internal user', () => {
    ...
    beforeEach(() => {
      Sinon.stub(UserModel, 'query').returns({
        ...
        select: Sinon.stub().resolves({ application: 'water_admin' })
      })
    ...
    it('returns the internal user page data', async () => {
      ...
      expect(viewInternalUserServiceStub.calledWith(userId)).to.be.true()
  ...
  describe('when the user is an external user', () => {
    ...
    beforeEach(() => {
      Sinon.stub(UserModel, 'query').returns({
        findById: Sinon.stub().returnsThis(),
        select: Sinon.stub().resolves({ application: 'water_vml' })
      })
    ...
    it('returns the external user page data', async () => {
      ...
      expect(viewExternalUserServiceStub.calledWith(userId)).to.be.true()
