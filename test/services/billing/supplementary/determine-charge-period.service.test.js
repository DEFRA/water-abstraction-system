        ...
        beforeEach(() => {
          chargeVersion = {
            ...
            licence: {
              ...
              revokedDate: new Date('2023-08-01')
            }
          }
        })
      ...
      describe('is before the billing period', () => {
        beforeEach(() => {
          chargeVersion = {
            ...
            licence: {
              startDate: new Date('2023-01-01'),
              revokedDate: new Date('2023-02-01')
            }
          }
        })
      ...
      describe('is inside the billing period', () => {
        beforeEach(() => {
          chargeVersion = {
            ...
            licence: {
              startDate: new Date('2023-01-01'),
              lapsedDate: new Date('2023-08-01')
            }
          }
        })
      ...
      describe('is before the billing period', () => {
        beforeEach(() => {
          chargeVersion = {
            ...
            licence: {
              startDate: new Date('2023-01-01'),
              lapsedDate: new Date('2023-02-01')
            }
          }
        })
      ...
      describe('is inside the billing period', () => {
        beforeEach(() => {
          chargeVersion = {
            ...
            licence: {
              startDate: new Date('2023-01-01'),
              expiredDate: new Date('2023-08-01')
            }
          }
        })
      ...
      describe("is inside the billing period before the charge version's start date", () => {
        beforeEach(() => {
          chargeVersion = {
            ...
            licence: {
              startDate: new Date('2023-01-01'),
              expiredDate: new Date('2023-06-01')
            }
          }
        })
