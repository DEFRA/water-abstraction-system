...
// Thing under test
const SubmitCancelService = require('../../../../app/services/return-requirements/setup/submit-cancel.service.js')

describe('Return Requirements Setup - Submit Cancel service', () => {
  let session
