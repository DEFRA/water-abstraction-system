...
const FetchExistingRequirementsService = require('../../../../app/services/return-requirements/setup/fetch-existing-requirements.js')

// Thing under test
const GenerateFromExistingRequirementsService = require('../../../../app/services/return-requirements/setup/generate-from-existing-requirements.service.js')

describe('Return Requirements Setup - Generate From Existing Requirements service', () => {
  let returnVersion
