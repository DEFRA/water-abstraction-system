...
// Thing under test
const SubmitAgreementsExceptionsService = require('../../../../app/services/return-requirements/setup/submit-agreements-exceptions.service.js')

describe('Return Requirements Setup - Submit Agreements and Exceptions service', () => {
  ...
  describe('with an invalid payload', () => {
    ...
    it('returns page data for the view', async () => {
      ...
      expect(result).to.equal({
        ...
        backLink: `/system/return-requirements/setup/${session.id}/frequency-reported/0`,
