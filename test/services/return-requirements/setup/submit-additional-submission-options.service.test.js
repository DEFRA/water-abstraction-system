...
// Thing under test
const SubmitAdditionalSubmissionOptionsService = require('../../../../app/services/return-requirements/setup/submit-additional-submission-options.service.js')

describe('Return Requirements Setup - Submit Additional Submission Options service', () => {
  let payload
  let session
  let yarStub
