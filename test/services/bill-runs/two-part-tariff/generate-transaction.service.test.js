  ...
  describe('when called', () => {
    it('returns a two-part tariff transaction ready to be persisted', () => {
      const result = GenerateTransactionService.go(
        billLicenceId, chargeReference, chargePeriod, newLicence, waterUndertaker
      )
      ...
      },
      {
        ...
        // calling `toJSON()` on the charge references child ChargeElementModel instances. Including it would just be us
        // testing Objection
        skip: ['id', 'purposes']
      })
    })
    ...
    describe('and the charge reference has a two-part tariff agreement (section 127)', () => {
      ...
      it('returns the two-part tariff prefixed description', () => {
        ...
        expect(result.description).to.equal('Two-part tariff basic water abstraction charge: Lower Queenstown - Pittisham')
      })
    })
  })
})
