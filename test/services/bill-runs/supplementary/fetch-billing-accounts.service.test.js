...
describe('Supplementary Fetch Billing Accounts service', () => {
  ...
  beforeEach(async () => {
    ...
    licence = await LicenceHelper.add({ regionId, includeInSrocBilling: true })
  ...
  describe('when there are billing accounts that should be considered for supplementary billing', () => {
    let changeReason
    let chargeCategory
    let chargeElement
    let chargeReference
  ...
  describe('when there are no billing accounts that should be considered for the supplementary bill run', () => {
    describe("because all their charge versions have a status of 'draft", () => {
      beforeEach(async () => {
