...
const InitiateSessionService = require('../../app/services/return-requirements/setup/initiate-session.service.js')
    ...
    describe('GET', () => {
      ...
      describe('when a request is valid', () => {
        ...
        it('redirects to select return start date page', async () => {
          ...
          expect(response.headers.location).to.equal(`/system/return-requirements/setup/${session.id}/start-date`)
        })
      })
