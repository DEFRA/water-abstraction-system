    ...
    describe('GET', () => {
      ...
      describe('when a request is valid', () => {
        ...
        it('redirects to select bill run type page', async () => {
          ...
          expect(response.headers.location).toEqual(`/system/bill-runs/setup/${session.id}/type`)
        })
      })
    })
  })
      ...
      describe('when the request succeeds', () => {
        describe('but there is an existing bill run', () => {
          ...
          it('returns the "check" page displaying the existing bill run', async () => {
            ...
            expect(response.payload).toContain('This bill run already exists')
            expect(response.payload).toContain('c0608545-9870-4605-a407-5ff49f8a5182')
          })
        })
        ...
        describe('and there is no existing bill run', () => {
          ...
          it('returns the "check" page displaying the bill run to be created', async () => {
            ...
            expect(response.statusCode).toEqual(HTTP_STATUS_OK)
            expect(response.payload).toContain('Check the bill run to be created')
          })
        })
      })
    })
    ...
    describe('GET', () => {
      ...
      describe('when the request succeeds', () => {
        it('returns the page successfully', async () => {
          ...
          expect(response.statusCode).toEqual(HTTP_STATUS_OK)
          expect(response.payload).toContain('Select the region')
        })
      })
    })
    ...
    describe('POST', () => {
      ...
      describe('when a request is invalid', () => {
        ...
        it('re-renders the page with an error message', async () => {
          ...
          expect(response.statusCode).toEqual(HTTP_STATUS_OK)
          expect(response.payload).toContain('Select a region')
    ...
    describe('GET', () => {
      ...
      describe('when the request succeeds', () => {
        it('returns the page successfully', async () => {
          ...
          expect(response.statusCode).toEqual(HTTP_STATUS_OK)
          expect(response.payload).toContain('Select the season')
        })
      })
    })
    ...
    describe('GET', () => {
      ...
      describe('when the request succeeds', () => {
        it('returns the page successfully', async () => {
          ...
          expect(response.statusCode).toEqual(HTTP_STATUS_OK)
          expect(response.payload).toContain('Select the bill run type')
        })
      })
    })
    ...
    describe('GET', () => {
      ...
      describe('when the request succeeds with at least 1 year to display', () => {
        ...
        it('returns the page successfully', async () => {
          ...
          expect(response.statusCode).toEqual(HTTP_STATUS_OK)
          expect(response.payload).toContain('Select the financial year')
        })
      })
    ...
    describe('POST', () => {
      ...
      describe('when a request is invalid', () => {
        ...
        it('re-renders the page with an error message', async () => {
          ...
          expect(response.statusCode).toEqual(HTTP_STATUS_OK)
          expect(response.payload).toContain('Select a financial year')
          expect(response.payload).toContain('There is a problem')
        })
      })
    })
