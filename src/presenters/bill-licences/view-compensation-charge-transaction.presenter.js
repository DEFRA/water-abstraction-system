...
import { formatLongDate, formatMoney } from 'water-abstraction-engine/presenters/base.presenter.js'
 ...
 */
export default function viewCompensationChargeTransactionPresenter(transaction) {
