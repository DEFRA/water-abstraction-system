...
import { roles } from 'water-abstraction-engine/lib/static-lookups.lib.js'
 ...
 */
export default function companyWithAddressPresenter(company, address, role, licenceId) {
