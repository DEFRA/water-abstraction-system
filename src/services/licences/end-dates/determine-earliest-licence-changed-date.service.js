...
import { compareDates, determineEarliestDate, sameDate } from 'water-abstraction-engine/lib/dates.lib.js'
 ...
 */
export default function determineEarliestLicenceChangedDateService(licence) {
