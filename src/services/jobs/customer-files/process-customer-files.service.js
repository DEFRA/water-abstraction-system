...
import BillingAccount from 'water-abstraction-engine/models/billing-account.model.js'
import ExpandedError from 'water-abstraction-engine/errors/expanded.error.js'
import {
  calculateAndLogTimeTaken,
  currentTimeInNanoseconds,
  timestampForPostgres
} from 'water-abstraction-engine/lib/general.lib.js'
 ...
 */
export default async function processCustomerFilesService(days) {
  try {
...
async function _fetchCustomerFiles(days) {
  const result = await ViewCustomerFilesRequest(days)
