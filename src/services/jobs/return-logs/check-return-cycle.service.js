...
import { determineCycleEndDate, determineCycleStartDate } from 'water-abstraction-engine/lib/return-cycle-dates.lib.js'
 ...
 */
export default async function checkReturnCycleService(summer) {
