...
import ViewMessageDataRequest from 'water-abstraction-engine/requests/notify/view-message-data.request.js'
...
async function _notifyStatus(notifyId) {
  const notifyResult = await ViewMessageDataRequest(notifyId)
