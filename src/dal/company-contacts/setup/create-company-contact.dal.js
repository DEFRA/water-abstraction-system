...
import LicenceRoleModel from 'water-abstraction-engine/models/licence-role.model.js'
 ...
 */
export default async function createCompanyContactDal(companyId, companyContact) {
