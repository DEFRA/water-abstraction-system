...
const data = [
  {
    ...
    groupId: groups.find((group) => {
      return group.group === 'environment_officer'
    }).id,
    roleId: roles.find((role) => {
      return role.role === 'hof_notifications'
    }).id
  },
  {
    id: '521867f4-5816-4fa5-8b01-3433ca304e18',
    groupId: groups.find((group) => {
      return group.group === 'billing_and_data'
    }).id,
    roleId: roles.find((role) => {
      return role.role === 'returns'
    }).id
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'bulk_return_notifications'
    }).id
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'manage_accounts'
    }).id
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'unlink_licences'
    }).id
  },
  {
    id: '9aa6163c-faf1-4167-b2ec-3346203f9365',
    groupId: groups.find((group) => {
      return group.group === 'wirs'
    }).id,
    roleId: roles.find((role) => {
      return role.role === 'returns'
    }).id
  ...
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'renewal_notifications'
    }).id
  },
  {
    id: 'c4bb2367-9491-42c3-844e-2717e20e1050',
    groupId: groups.find((group) => {
      return group.group === 'psc'
    }).id,
    roleId: roles.find((role) => {
      return role.role === 'unlink_licences'
    }).id
  ...
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'charge_version_workflow_editor'
    }).id
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'charge_version_workflow_reviewer'
    }).id
  },
  {
  ...
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'manage_agreements'
    }).id
  },
  {
  ...
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'delete_agreements'
    }).id
  },
  {
  ...
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'manage_billing_accounts'
    }).id
  },
  {
  ...
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'manage_gauging_station_licence_links'
    }).id
  },
  {
  ...
  },
  {
    ...
    roleId: roles.find((role) => {
      return role.role === 'view_charge_versions'
    }).id
  },
  {
